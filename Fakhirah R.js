...
if (reversed == null) { reversed = false; }
	...
	this.text.lineWidth = 49;
	this.text.parent = this;
	this.text.setTransform(342.55,30.3);

	this.text_1 = new cjs.Text("Tombol", "50px 'Comic Sans MS'", "#FFFFFF");
	this.text_1.lineHeight = 72;
	this.text_1.lineWidth = 179;
	this.text_1.parent = this;
	this.text_1.setTransform(58.05,34.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_1,p:{x:58.05,y:34.4,lineWidth:179}},{t:this.text,p:{x:342.55,y:30.3}}]}).to({state:[{t:this.text_1,p:{x:56.05,y:32.75,lineWidth:185}},{t:this.text,p:{x:340.55,y:29.65}}]},1).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,0,421,109);
...
if (reversed == null) { reversed = false; }
	...
	this.text.lineWidth = 49;
	this.text.parent = this;
	this.text.setTransform(342.55,28.4);

	this.text_1 = new cjs.Text("Tombol", "50px 'Comic Sans MS'", "#FFFFFF");
	this.text_1.lineHeight = 72;
	this.text_1.lineWidth = 179;
	this.text_1.parent = this;
	this.text_1.setTransform(58.05,32.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_1,p:{x:58.05,y:32.4,color:"#FFFFFF",lineWidth:179}},{t:this.text,p:{x:342.55,y:28.4,color:"#000000"}}]}).to({state:[{t:this.text_1,p:{x:56.05,y:34.75,color:"#000000",lineWidth:185}},{t:this.text,p:{x:340.55,y:31.65,color:"#FFFFFF"}}]},1).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,0,421,110.3);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btn_tmblA,p:{y:228.45}}]}).to({state:[{t:this.btn_tmblA,p:{y:229.45}}]},2).to({state:[{t:this.btn_tmblB}]},2).to({state:[{t:this.btn_tmblB},{t:this.btn_tmblC}]},5).to({state:[{t:this.btn_tmblB},{t:this.btn_tmblC},{t:this.btn_tmblD}]},5).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(422.6,418,101.39999999999998,-128.7);
// library properties:
lib.properties = {
